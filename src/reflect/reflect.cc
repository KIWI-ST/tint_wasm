...
#define LOGE(...) PrintError(__VA_ARGS__);
    ...
    ) const
    {
        ...
        LOGI("[WGSLReflector][ReflectShaderUniforms] attribute count: %d.", attribute_count);
    }
    ...
    ) const
    {
        ...
        LOGI("[WGSLReflector][ReflectShaderUniforms] bind group count: %d.", bind_group_count);
    }
}
